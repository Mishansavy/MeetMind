...
export default function AdminRecordings() {
    ...
    const download = async (recording) => {
        ...
        a.href = url;
        a.download = `${recording.room_code}_${recording.user_name}.webm`;
        a.click();
    ...
    return (
        <AdminShell>
            <PageHeader
                icon={Film}
                title="Recordings"
                description={`${recordings.length} recording${recordings.length === 1 ? "" : "s"} across all meetings`}
            />
                ...
                <CardContent className="p-0">
                    {loading ? (
                        ...
                        <EmptyState
                            ...
                            description="Recordings from meetings will appear here once participants save them."
                        />
                    ) : (
                        <Table>
                            <TableHeader>
                            ...
                            <TableBody>
                                {recordings.map((r) => (
                                    <TableRow key={r.id}>
                                        ...
                                        <TableCell className="text-muted-foreground">{r.room_title || "Untitled meeting"}</TableCell>
