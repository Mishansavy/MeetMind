...
export default function AdminAppLayout({ nav, brand, subtitle, children }) {
    ...
    const sidebarBg = "relative overflow-hidden bg-gradient-to-br from-sidebar-from to-sidebar-to";
    const borderTone = "border-white/10";
    ...
    const sidebar = (
        <div className="relative flex h-full flex-col">
            ...
            />
            <div className="pointer-events-none absolute -bottom-24 -left-24 h-72 w-72 rounded-full bg-white/5 blur-2xl" />
            ...
            <div className={cn("relative flex h-16 shrink-0 items-center gap-3 border-b px-4", borderTone)}>
                ...
                <div>
                    <p className="text-sm font-semibold leading-none text-white">{brand}</p>
            ...
            <div className={cn("relative border-t px-3 py-3", borderTone)}>
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <button className="flex w-full items-center gap-2.5 rounded-lg px-2 py-2 text-left transition-colors duration-150 hover:bg-white/5">
                            ...
                            <ChevronDown className="h-4 w-4 shrink-0 text-white/65" />
                        </button>
                    </DropdownMenuTrigger>
        ...
        <div className="flex min-h-screen bg-muted/20">
            ...
            <div className={cn("fixed inset-x-0 top-0 z-30 flex h-14 items-center gap-3 border-b px-4 lg:hidden bg-gradient-to-br from-sidebar-from to-sidebar-to", borderTone)}>
                <button
                    ...
                    className="flex h-8 w-8 items-center justify-center rounded-md transition-colors duration-150 text-white/75 hover:bg-white/5 hover:text-white"
                >
